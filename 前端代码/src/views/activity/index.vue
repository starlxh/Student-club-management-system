  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogDetailFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          :type="dialogStatus === 'detail' ? '' : 'danger'"
          @click="
            dialogStatus === 'detail' ? (dialogDetailFormVisible = false) : handleJudge(2)
          "
        >
        ...
        <el-button
          ...
          :disabled="temp.status != 0"
          @click="dialogStatus === 'detail' ? handleCheck() : handleJudge(1)"
        >
