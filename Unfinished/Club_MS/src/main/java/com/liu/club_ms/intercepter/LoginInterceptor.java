    ...
    public boolean preHandle(HttpServletRequest request,
        ...
        if(token == null || token.isEmpty()){
            ...
            if (res == 20000){
                ...
                admin.setAdminId(JWUtil.getAdminId(token));
                admin.setAdminType(JWUtil.getAdminType(token));
                admin.setAdminName(JWUtil.getAdminName(token));
                token=JWUtil.generateToken(admin);
